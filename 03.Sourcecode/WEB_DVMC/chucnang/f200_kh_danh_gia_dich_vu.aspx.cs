...
{
    public partial class f200_kh_danh_gia_dich_vu : System.Web.UI.Page
    {
    ...
    private void luu_danh_gia_don_hang()
    {
        ...
        if (v_dc_id_danh_gia > 124 && v_str_y_kien_khac == "") { m_lbl_message.Text = "xin vui lòng cho ý kiến"; return; }
