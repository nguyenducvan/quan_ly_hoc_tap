...
namespace TSBK
{
    ...
    public class US_DUNG_CHUNG : US_Object
    {
        ...
        internal void FillDatasetLogin(DataSet v_ds, string m_user, string m_pass)
        {
            CStoredProc v_cstore = new CStoredProc("pr_login");
            v_cstore.addNVarcharInputParam("@string_user", m_user);
            v_cstore.addNVarcharInputParam("@string_password", m_pass);
            v_cstore.ExecuteCommand(this);
        }
    }
