<%@ Page Title="" Language="C#" MasterPageFile="~/Home2.master"  CodeBehind="f200_kh_danh_gia_dich_vu.aspx.cs" Inherits="WEB_DVMC.chucnang.f200_kh_danh_gia_dich_vu" %>
        ...
        <div style=" font-size:25px; font-weight:bold; color:RGB(129,12,21);" >
            ...
            <div class='div-right'>
                ...
                <div class="textbox-search">
                    ...
                    <%--<asp:Calendar runat="server" ID="m_dat_ngay_dat_hang" /> --%>
                </div>
            </div>
